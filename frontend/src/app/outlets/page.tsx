...
// Statis: backend belum punya endpoint outlet.
const outlets = [
  {
    id: 1,
    name: "Cafe A",
    city: "Bandung",
    address: "Jl. Braga No. 12, Bandung 40111",
  ...
  },
  {
    ...
    name: "Cafe B",
    city: "Tasikmalaya",
    address: "Jl. HZ Mustofa No. 45, Tasikmalaya 46111",
          ...
          <div key={o.id} className="overflow-hidden rounded-2xl border border-polks-border bg-white">
            <div className="flex items-center justify-between bg-polks-brand px-4 py-3">
              <div className="flex items-baseline gap-2">
                ...
                <span className="text-xs text-white/50">{o.city}</span>
              </div>
